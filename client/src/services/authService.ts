 ...
 */
export const loginService = async (data: Login) => await apiCall("post", LOGIN, data)

/**
 * Registers a new user.
 */
export const registerService = async (data: Register) => await apiCall("post", REGISTER, data)
